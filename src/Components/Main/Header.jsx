      ...
      <div className='grid md:grid-cols-2 gap-4 py-32 px-1 bg-transparent'>
        ...
        <div className='text-white min-h-72'>
          <ReactTyped
            ...
            <h1 class='text-2xl font-thin mb-10'>End-to-End Python AI Engineer</h1>
            `]}
            typeSpeed={10}
            showCursor={false}
          ...
          />
          {
            !isTyping &&
            <>
              <button onClick={() => window.location.href = '#contact'} className='text-2xl animate-pulse p-4 px-24 mb-10 font-thin bg-sky-500 rounded-badge'>Hire me</button>
